module.exports = {
    ...
    try {
      ...
      await queryInterface.addColumn(
        ...
        'category',
        {
          ...
          values: ['Corporate', 'Family', 'Criminal', 'Civil', 'Other'],
        },
        { transaction },
      );
  ...
  async down(queryInterface, Sequelize) {
    ...
    try {
      ...
      await queryInterface.removeColumn('notes', 'userId', { transaction });

      await queryInterface.removeColumn('notes', 'content', { transaction });

      await queryInterface.removeColumn('metrics', 'userId', { transaction });
