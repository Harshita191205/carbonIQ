...
const config = {
  gcloud: {
    bucket: 'fldemo-files',
    hash: '49dece9c1f4e2fcb66271a00498f66f6',
  },
  bcrypt: {
    saltRounds: 12,
  },
  ...
  uploadDir: os.tmpdir(),
  email: {
    from: 'develop a aap for carbonIQ <app@flatlogic.app>',
  ...
  project_uuid: '9e04e670-93b7-425d-b2dc-6648e6569d89',
  flHost:
...
config.pexelsQuery = 'connecting departments in harmony';
config.host =
