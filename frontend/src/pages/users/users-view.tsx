    ...
    <>
      ...
      <SectionMain>
        ...
        <CardBox>
            ...
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {users.activities_user &&
                      Array.isArray(users.activities_user) &&
          ...
          <>
            <p className={'block font-bold mb-2'}>Metrics User</p>
            <CardBox
              className='mb-6 border border-gray-300 rounded overflow-hidden'
              hasTable
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {users.metrics_user &&
                      Array.isArray(users.metrics_user) &&
                      users.metrics_user.map((item: any) => (
                        <tr
                          key={item.id}
                          onClick={() =>
          ...
          <>
            <p className={'block font-bold mb-2'}>Notes User</p>
            <CardBox
              className='mb-6 border border-gray-300 rounded overflow-hidden'
              hasTable
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {users.notes_user &&
                      Array.isArray(users.notes_user) &&
                      users.notes_user.map((item: any) => (
                        <tr
                          key={item.id}
                          onClick={() =>
